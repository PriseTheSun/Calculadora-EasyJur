...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Objeto com referências aos elementos de resultado
    const resultado = {
    ...
    sliderHorasTrabalhadas.oninput = () => atualizarSlider(sliderHorasTrabalhadas, outputHorasTrabalhadas);
    sliderValorHora.oninput = () => atualizarSlider(sliderValorHora, outputValorHora);
